...
abstract class HeaderBehavior<V: View>: ViewOffsetBehavior<V> {
    ...
    open fun setHeaderTopBottomOffset(parent: CoordinatorLayout?, header: V, newOffset: Int): Int {
    ...
    open fun setHeaderTopBottomOffset(
        ...
        if (curOffset in minOffset..maxOffset) {
            ...
            if (curOffset != newOffset) {
                setTopAndBottomOffset(MathUtils.clamp(newOffset, minOffset, maxOffset))
